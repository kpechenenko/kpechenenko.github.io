...
После окончания лекций дается 1 месяца на разработку и защиту финального проекта. Проект выполняется единолично. Защита проекта - получение оценки от проверяющего, который просмотрел код проекта. 
